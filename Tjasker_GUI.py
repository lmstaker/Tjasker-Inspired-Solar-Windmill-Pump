...
from tkinter.messageb5ox import showinfo
from ttkthemes import ThemedTk
from time import sleep
#Initialize window, default to dark mode theme
#Enable switching to light and high contrast
...
esc.add_command(label='Exit',command=root.destroy)
...
def mode_selected():
    ...
    if mode == 'Set Run':
        ...
        def spin():
            ...
            elif 10 > speed: #Reject speeds too slow for motor movement
        ...
        def spin():
            ...
            if (direction != 'True') and (direction != 'False'):
                ...
                spinning = True
                turn  = [direction,speed]
                #Replaces spin button with stop button
                changemode_button.destroy()
                spin_button.destroy()
        ...
        showinfo(title='Error', message=msg)
'''Scans for whether motor is "spinning" every 1000 milliseconds,
